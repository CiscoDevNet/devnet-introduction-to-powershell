...
List all the PowerShell Output Cmdlets
  ...
  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-04.jpg)<br/><br/>
  ...
  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-05.jpg)<br/><br/>
...
Sort `Get-Command` output by the **Version** number.
  ...
  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-06.jpg)<br/><br/>
  ...
  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-07.jpg)<br/><br/>
...
Use `Out-GridView` to manipulate Cmdlet output.
  ...
  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-08.jpg)<br/><br/>

  2. *Click* on the `Version` column to sort by **Version**

  3. *Click* on the `Name` column to sort by **Name**

  4. *Click* on the ![](assets/images/image-09.jpg) ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-09.jpg) button, *check* `Version` and *click* `Add`

  ![](assets/images/image-10.jpg)<br/><br/>

  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-10.jpg)<br/><br/>

  5. *Click* on the `contains` link and *click* on `equals`

  ![](assets/images/image-11.jpg)<br/><br/>

  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-11.jpg)<br/><br/>

  6. Enter `3.0.0.0` in the field next to `equals`, the result should show just Cmdlets with a **Version** of `3.0.0.0`

  ![](assets/images/image-12.jpg)<br/><br/>

  ![](/posts/files/introduction-to-powershell-pipelining-and-output/assets/images/image-12.jpg)<br/><br/>
